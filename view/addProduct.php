                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <form id="addProductForm" method="POST">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="code">Código de producto</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <?php if (count($product_data) != 0) { ?>
                                <input type="text" id="code" name="code" class="form-control" placeholder="Ingresa el código del producto" value="<?php echo $product_data['code'] ?>"/>
                              <?php } else { ?>
                                <input type="text" id="code" name="code" class="form-control" placeholder="Ingresa el código del producto"/>
                              <?php } ?>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <?php if (count($product_data) != 0) { ?>
                                <input type="text" id="name" name="name" class="form-control" placeholder="Ingresa el nombre del producto" value="<?php echo $product_data['name'] ?>"/>
                              <?php } else { ?>
                                <input type="text" id="name" name="name" class="form-control" placeholder="Ingresa el nombre del producto"/>
                              <?php } ?>
                            ...
                            <div class="input-group input-group-merge">
                              <select class="form-select" id="category" name="category" aria-label="Default select example">
                                <?php foreach ($categories as $key => $data) { ?>
                                  <?php if (count($product_data) != 0) { ?>
                                    <?php if ($product_data['id_categories'] == $data['id']) { ?>
